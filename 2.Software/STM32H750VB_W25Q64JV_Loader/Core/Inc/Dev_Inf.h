...
#define MEMORY_FLASH_SIZE (8 * 1024 * 1024)	//总容量：8M字节
#define MEMORY_PAGE_SIZE (0x100)			//页大小：256byte/2kbit
#define MEMORY_SECTOR_SIZE (0x1000)			//扇区大小：4k
#define MEMORY_BLOCK_SIZE (0x10000)			//块大小：64k
